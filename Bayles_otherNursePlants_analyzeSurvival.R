...
dalpur_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Dalpur_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
desill_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Desill_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
echpur_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Echpur_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
cortri_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Cortri_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
schsco_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Schsco_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
lescap_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Lescap_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
allcer_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Allcer_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
liaspi_LossData <- read.table("~/Box Sync/R_code/Bayles_biochar/Bayles_forGitHub/Bayles_Liaspi_lossDates_through2014_ForR.csv", header = TRUE, sep = ",")
