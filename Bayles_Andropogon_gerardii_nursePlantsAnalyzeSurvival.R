...
andgerLossData <- read.table("~/Prairie-Restoration-Experiment-BaylesRoad-master/Bayles_Andger_lossDatesForR.csv", header = TRUE, sep = ",")
...
print(summary(andger_fullSurvival))
